 ...
 */
class Radial_CreditCard_Test_Model_Order_Create_PaymentTest extends Radial_Core_Test_Base
{
    ...
    public function setUp()
    {
        ...
        $methodCode = Mage::getModel('radial_creditcard/method_ccpayment')
            ->getCode();
    ...
    public function testAddPaymentsToPayloadUsePan()
    {
        ...
        $handler = Mage::getModel('radial_creditcard/order_create_payment');
    ...
    /**
     * verify
     * - non radial_creditcard payment will not be made into a payload
     */
    public function testAddPaymentsToPayloadNonCreditCardPayment()
    {
        $processedPayments = new SplObjectStorage();
        $this->_paymentStub->setMethod('non-radial_creditcard');
