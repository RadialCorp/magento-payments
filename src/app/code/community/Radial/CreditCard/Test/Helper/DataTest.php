...
class Radial_CreditCard_Test_Helper_DataTest extends Radial_Core_Test_Base
{
    /**
    ...
    public function testGetTenderTypeForCcType($ccType)
    {
        $tenderType = 'VC';
        $mappedType = 'VI';
        $helper = $this->getHelperMock('radial_creditcard/data', array('getConfigModel'));
    ...
    public function testCleanPaymentsXml()
    {
        ...
        $this->assertSame(
            ...
            Mage::helper('radial_creditcard')->cleanPaymentsXml($xml)
        );
    }
    /**
    ...
    public function testGetAvailableCardTypes()
    {
        ...
        $helper = $this->getHelperMock('radial_creditcard', array('getConfigModel', '_getGlobalPaymentConfig'));
        $helper->expects($this->any())
            ->method('getConfigModel')
