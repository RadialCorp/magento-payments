...
class Radial_CreditCard_Block_Form_Cc extends Mage_Payment_Block_Form_Cc
{
    ...
    {
        parent::_construct();
        $this->_config = Mage::helper('radial_creditcard')->getConfigModel();
        $this->setTemplate('radial_creditcard/form/cc.phtml');
    }
    /**
