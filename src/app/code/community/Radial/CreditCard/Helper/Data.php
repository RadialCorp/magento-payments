...
class Radial_CreditCard_Helper_Data extends Mage_Core_Helper_Abstract implements Radial_Core_Helper_Interface
{
    const UNKNOWN_CARD_TYPE = 'Radial_CreditCard_Unknown_Card_Type';
    ...
    public function getConfigModel($store = null)
    {
        return Mage::getModel('radial_core/config_registry')
            ->setStore($store)
            ->addConfigModel(Mage::getSingleton('radial_creditcard/config'));
    }
    /**
    ...
    public function getTenderTypeForCcType($creditCardType)
    {
        ...
        throw Mage::exception('Radial_CreditCard', self::UNKNOWN_CARD_TYPE);
    }
    /**
