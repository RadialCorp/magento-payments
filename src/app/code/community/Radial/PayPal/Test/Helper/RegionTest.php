...
class Radial_Paypal_Test_Helper_RegionTest extends Radial_Core_Test_Base
{
    ...
    public function testSetQuoteAddressRegion()
    {
        ...
        /** @var Radial_PayPal_Helper_Region $regionHelper */
        $regionHelper = Mage::helper('radial_paypal/region');
