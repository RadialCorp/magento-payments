 ...
 * Test Order Create
 */
class Radial_PayPal_Test_Model_Order_Create_PaymentTest extends Radial_Core_Test_Base
{
    ...
    public function setUp()
    {
        ...
        $payment1->setCreatedAt('2012-01-01 00:00:00')
            ->setMethod(Mage::getModel('radial_paypal/method_express')->getCode());
    ...
    public function testAddPaymentsToPayload()
    {
        ...
        $handler = Mage::getModel('radial_paypal/order_create_payment');
