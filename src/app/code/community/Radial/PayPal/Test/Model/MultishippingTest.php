...
class Radial_Paypal_Test_Model_MultishippingTest extends Radial_Core_Test_Base
{
    /**
    ...
    public function testInitializePaypalExpressCheckout($isRedirectToPayPal)
    {
        ...
        $multiShipping = $this->getModelMock('radial_paypal/multishipping', ['getCheckoutSession', 'isRedirectToPayPal', 'getPayPalExpressStartupUrl']);
    ...
    {
        return [
            [['method' => Radial_PayPal_Model_Method_Express::CODE], true],
            [['method' => Radial_PayPal_Model_Method_Express::CODE, 'is_return_from_paypal' => true], false],
            [[], false],
        ];
    }
    ...
    {
        /** @var Radial_PayPal_Model_Multishipping */
        $multiShipping = Mage::getModel('radial_paypal/multishipping');
    ...
    public function testProcessPaypalExpressPayment()
    {
        ...
        $payment->expects($this->once())
            ->method('getMethod')
            ->will($this->returnValue(Radial_PayPal_Model_Method_Express::CODE));
        $payment->expects($this->once())
            ->method('importData')
        ...
        $api = $this->getModelMock('radial_paypal/express_api', ['doExpressCheckout', 'doAuthorization']);
        ...
        /** @var Radial_PayPal_Model_Multishipping */
        $multiShipping = Mage::getModel('radial_paypal/multishipping', ['api' => $api]);
