...
class Radial_PayPal_Test_Model_Method_ExpressTest extends Radial_Core_Test_Base
{
    /** @var Radial_PayPal_Model_Express_Payment_Info */
    ...
    {
        $rawModel = Mage::getModel('radial_paypal/method_express');
    ...
    public function testAssignData($isDataObject)
    {
        ...
        $express = Mage::getModel('radial_paypal/method_express');
        ...
        $this->assertSame(
            'right one',
            $info->getAdditionalInformation(Radial_PayPal_Model_Express_Checkout::PAYMENT_INFO_ADDRESS_STATUS)
        );
    }
}
