...
class Radial_PayPal_Test_Model_Order_Create_ContextTest extends Radial_Core_Test_Base
{
    public function testUpdateOrderContext()
    {
        $payment = Mage::getModel('sales/order_payment', ['method' => 'radial_paypal_express']);
        ...
        $handler = Mage::getModel('radial_paypal/order_create_context');
