...
class Radial_PayPal_Test_Block_Payment_MarkTest extends Radial_Core_Test_Base
{
    ...
    protected $locale;
    /** @var Radial_PayPal_Block_Payment_Mark */
    protected $block;
    ...
    public function setUp()
    {
        ...
        $this->block = new Radial_PayPal_Block_Payment_Mark;
