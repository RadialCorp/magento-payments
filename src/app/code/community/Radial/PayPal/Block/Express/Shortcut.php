 ...
 */
class Radial_PayPal_Block_Express_Shortcut extends Mage_Core_Block_Template
{
    const VISIBLE_PRODUCT = 'visible_on_product';
    const VISIBLE_CART = 'visible_on_cart';
    const HTML_ID_PREFIX = 'radial_paypal_shortcut_';
    ...
    protected $_paymentMethodCode = 'radial_paypal_express';
    /**
     ...
     * @var string
     */
    protected $_checkoutType = 'radial_paypal/express_checkout';
