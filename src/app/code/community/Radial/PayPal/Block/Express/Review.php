 ...
 */
class Radial_PayPal_Block_Express_Review extends Mage_Core_Block_Template
{
    /**
    ...
    {
        parent::_construct();
        $this->_quote = Mage::helper('radial_paypal')->getQuote();
     ...
     *
     * @return Radial_Paypal_Block_Express_Review
     */
