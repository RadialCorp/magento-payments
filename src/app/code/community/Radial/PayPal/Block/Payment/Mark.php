 ...
 */
class Radial_PayPal_Block_Payment_Mark extends Mage_Core_Block_Template
{
    const ALT_TEXT_MESSAGE = 'RADIAL_PAYPAL_PAYMENT_MARK_ALT_TEXT';
    ...
    {
        $this->helper = Mage::helper('radial_paypal');
        $this->config = $this->helper->getConfigModel();
        $this->setTemplate('radial_paypal/payment/mark.phtml');
    }
