 ...
 */
class Radial_PayPal_Block_Logo extends Mage_Core_Block_Template
{
    ...
    /** @var Radial_Core_Model_Config_Registry $_config */
    protected $_config;

    public function _construct()
    {
        parent::_construct();
        $this->_config = Mage::helper('radial_paypal')->getConfigModel();
        $this->addData(array(
