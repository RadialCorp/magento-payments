...
class Radial_PayPal_Model_Multishipping
{
    ...
    public function __construct(array $initParams=[])
    {
        list($this->api) = $this->checkTypes(
            $this->nullCoalesce($initParams, 'api', Mage::getModel('radial_paypal/express_api'))
        );
    }
     ...
     * @return array
     */
    protected function checkTypes(Radial_Paypal_Model_Express_Api $api)
    {
    ...
    protected function isRedirectToPayPal(array $paymentData)
    {
        ...
        return $paymentMethod === Radial_PayPal_Model_Method_Express::CODE
            && !$isReturnFromPaypal;
    }
    ...
    public function processPaypalExpressPayment(Mage_Sales_Model_Quote $quote)
    {
        ...
        if ($quote->getIsMultiShipping() && $paymentMethod === Radial_PayPal_Model_Method_Express::CODE) {
