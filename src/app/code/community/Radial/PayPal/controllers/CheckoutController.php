...
/**
 * Checkout Controller for PayPal
 */
class Radial_PayPal_CheckoutController extends Mage_Core_Controller_Front_Action
{
    /** @var Radial_Paypal_Model_Express_Checkout */
    ...
    public function startAction()
    {
        try {
            ...
            try {
                ...
                return;
            } catch (Radial_PayPal_Exception $e) {
    ...
    public function reviewAction()
    {
        ...
        try {
            ...
            $this->loadLayout();
            $this->_initLayoutMessages('radial_paypal/session');
            $this->renderLayout();
            return;
        } catch (Mage_Core_Exception $e) {
     ...
     *
     * @return Radial_PayPal_CheckoutController
    ...
    protected function _initCheckout()
    {
        ...
        $this->_checkout = Mage::getSingleton(
            'radial_paypal/express_checkout',
            array(
                'helper' => $this->_helper,
                'logger' => null,
                'config' => $this->_config,
     ...
     *
     * @return Radial_PayPal_CheckoutController |string
     */
     ...
     *
     * @return Radial_PayPal_Model_Session
     */
    private function _getSession()
    {
        return Mage::getSingleton('radial_paypal/session');
    }
    ...
    {
        if (!$this->_quote) {
            return Mage::helper('radial_paypal')->getQuote();
        }
        return $this->_quote;
    }
